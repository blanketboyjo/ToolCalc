...
public class ToolCalc extends javax.swing.JFrame {
    ...
    private void showMainPicture(){
        if(1 == m_toolType){
            if(1 == m_tool){
                if(2 == m_toolDim){
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/drill/DiaDrill.jpg")));                    
                }else{
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/drill/PlainDrill.jpg")));
                }
            }else if(2 == m_tool){
                if(2 == m_toolDim){
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/centerdrill/DiaCenterdrill.jpg")));
                }else{
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/centerdrill/PlainCenterdrill.jpg")));
                }
            }else if(3 == m_tool){
                if(2 == m_toolDim){
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/countersink/DiaCountersink.jpg")));
                }else{
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/countersink/PlainCountersink.jpg")));
                }
            }else if(4 == m_tool){
                if(2 == m_toolDim){
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/counterbore/DiaCounterbore.jpg")));
                }else{
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/counterbore/PlainCounterbore.jpg")));
                }
            }else if(5 == m_tool){
                if(2 == m_toolDim){
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/reamer/DiaReamer.jpg")));
                }else{
                    picture .setIcon(new javax.swing.ImageIcon(getClass()
                            .getResource("/picture/reamer/PlainReamer.jpg")));
                }
            }
        }else if(2 == m_toolType){
            if(2 == m_toolDim){
                picture     .setIcon(new javax.swing.ImageIcon(getClass()
                        .getResource("/picture/endmill/DiaEndmill.jpg")));
            }else if(3 == m_toolDim){
                picture     .setIcon(new javax.swing.ImageIcon(getClass()
                        .getResource("/picture/endmill/FlutesEndmill.jpg")));
            }else{
                picture     .setIcon(new javax.swing.ImageIcon(getClass()
                        .getResource("/picture/endmill/PlainEndmill.jpg")));
            }
        }else{
            picture         .setIcon(new javax.swing.ImageIcon(getClass()
                        .getResource("/picture/machining.gif")));
        }
    }
    /**
